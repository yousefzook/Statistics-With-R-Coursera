...
```{r gained-mature-ht}
# type your code for the Exercise here, and Knit
inference(y = weight, x = mature, data = nc, statistic = "mean", type = "ht", method = "theoretical", null = 0, alternative = "twosided")
```
...
nc %>% group_by(mature) %>% summarise(min = min(mage), max = max(mage))
```
